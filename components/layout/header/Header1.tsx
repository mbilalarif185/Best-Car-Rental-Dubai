				...
				<div className="top-bar top-bar-2 top-bar-3 bg-transparent">
					<div className="container-fluid">
						<div className="text-header-info">
							...
							<Link className="email-head text-white" href="mailto:info@legendarycarrental.ae" target="_blank" rel="noopener noreferrer">
								...
								<span className="d-none d-lg-inline-block">info@legendarycarrental.ae</span>
							</Link>
						</div>
						...
						<div className="top-right-header">
							...
							<Dropdown className="d-none d-xl-inline-block box-dropdown-cart align-middle head-currency">
								...
								<Dropdown.Menu style={{visibility: 'visible'}} className="dropdown-cart">
									<ul>
										<li><Link className="text-sm-medium" href="#">AED</Link></li>
