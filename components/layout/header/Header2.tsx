				...
				<div className="top-bar top-bar-2 top-bar-3 @@bg">
					<div className="container-fluid">
						<div className="text-header-info">
							<Link className="phone-head text-white" href="https://wa.me/971545514155">
							...
							<Link className="email-head text-white"  href="mailto:info@bestcarrentaldubai.ae">
						...
						<div className="text-header">
							<div className="text-unlock text-sm-medium text-white">More than <span className="text-primary">100+</span> Luxury Cars Collection </div>
