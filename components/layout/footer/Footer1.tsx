				...
				<div className="container">
					...
					<div className="row">
						<div className="col-md-3 col-sm-12 footer-1">
							<div className=" mb-30 ">
								...
								<div className="box-info-contact mt-0">
									...
									<p className="text-md neutral-400 icon-email">info@legendarycarrental.ae</p>
								</div>
						...
						<div className="col-md-2 col-xs-6 footer-4">
							...
							<ul className="menu-footer">
								<li><Link href="/cars/rent-bmw-430i-in-dubai">BMW 430i</Link></li>
								<li><Link href="/cars/rent-lamborghini-urus-in-dubai">Lamborghini Urus</Link></li>
								<li><Link href="/cars/rent-mercedes-amg-gtr-in-dubai">Mercedes AMG GTR</Link></li>
								<li><Link href="/cars/rent-porsche-macan-gts-in-dubai">Porsche Macan GTS</Link></li>
								<li><Link href="/cars/rent-range-rover-vogue-in-dubai">Range Rover Vogue</Link></li>
								{/* <li><Link href="/cars/rent-mercedes-g63-in-dubai">Mercedes G63</Link></li> */}
							...
							<div className="col-md-6 text-md-end text-center mb-20">
								<div className="d-flex align-items-center justify-content-center justify-content-md-end">
									...
									<div className="box-socials-footer d-inline-block">
										<Link className="icon-socials icon-instagram" href="https://www.instagram.com/legendary_carrental?igsh=MWd4aGdsbHduYmIzNQ==">
										...
										<Link className="icon-socials icon-facebook" href="https://www.facebook.com/Legendarycarrental">
											<svg xmlns="http://www.w3.org/2000/svg" width={21} height={20} viewBox="0 0 21 20" fill="none">
