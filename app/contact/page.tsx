										...
										<div className="card-info">
											...
											<div className="card-method-contact">
												...
												<div className="d-flex align-items-start mb-2">
													...
													<Link className="phone text-md-medium ms-2" href="/tel:+60 111 102 0111">+60 111 102 0111</Link>
												</div>
										...
										<div className="card-info">
											...
											<div className="card-method-contact">
												<div className="d-flex align-items-start mb-2">
													...
													<Link className="location text-md-medium ms-2" href="/googlemaps.com">Plot 25 street 4 - Al Quoz - Al Quoz Industrial Area 4 - Dubai</Link>
												</div>
												<div className="d-flex align-items-start mb-2">
													<div className="icon">
														<svg className="invert" xmlns="http://www.w3.org/2000/svg" width={20} height={21} viewBox="0 0 20 21" fill="none">
